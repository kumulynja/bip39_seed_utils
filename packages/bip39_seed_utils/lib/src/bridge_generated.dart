...
class Mnemonic {
  ...
  static Future<Mnemonic> newMnemonic({required Bip39SeedUtils bridge, required Language language, required WordCount wordCount, dynamic hint}) => bridge.newStaticMethodMnemonic(language: language, wordCount: wordCount, hint: hint);

  static Future<Mnemonic> fromPhrase({required Bip39SeedUtils bridge, required String phrase, dynamic hint}) => bridge.fromPhraseStaticMethodMnemonic(phrase: phrase, hint: hint);
...
class Bip39SeedUtilsImpl implements Bip39SeedUtils {
  final Bip39SeedUtilsPlatform _platform;
  factory Bip39SeedUtilsImpl(ExternalLibrary dylib) => Bip39SeedUtilsImpl.raw(Bip39SeedUtilsPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory Bip39SeedUtilsImpl.wasm(FutureOr<WasmModule> module) => Bip39SeedUtilsImpl(module as ExternalLibrary);
  Bip39SeedUtilsImpl.raw(this._platform);
  Future<Mnemonic> newStaticMethodMnemonic({required Language language, required WordCount wordCount, dynamic hint}) {
