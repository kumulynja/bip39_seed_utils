...
class Bip39SeedUtilsPlatform extends FlutterRustBridgeBase<Bip39SeedUtilsWire> {
  Bip39SeedUtilsPlatform(ffi.DynamicLibrary dylib) : super(Bip39SeedUtilsWire(dylib));
...
class Bip39SeedUtilsWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  Bip39SeedUtilsWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Bip39SeedUtilsWire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
